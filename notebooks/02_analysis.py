...
# %%
# Racunanje SNR za izvornu ASCAD bazu koja zauzima ~7GB moze potrajati koj minut
...
# %%
ax = analysis.plot_snr(snrs, 45000, 47500, None)
plt.savefig('snr.png')
plt.show()
...
#
# Konkretan opseg je `[45400, 46100]`

# %%
ax = analysis.plot_snr(snrs, 45400, 46100, None)
plt.show()
